  ...
  return (
    <header className="relative">
      <aside className={
        ...
        {/* Brand Logo */}
        <div className="font-bold text-2xl border-b border-zinc-100/10 p-5 text-left">Blog Admin Panel</div>
...
function MenuButton({props}: {
    ...
    <>
        <button className={clsx("bg-zinc-600 active:scale-95 hover:bg-zinc-600/50 shadow-2xs fixed z-1000 top-3 transition-all duration-300 rounded-full aspect-square flex", 
            {"right-2 left-auto md:left-[260px] md:right-auto p-1 top-5!": !collapse},
