      ...
      >
        ...
        <div
          className={clsx("blog-form-header flex justify-between w-full", {
            "fixed left-0 bottom-0 bg-zinc-900 px-2 py-4 border-t border-gray-500":
              isMobile,
          })}
        >
          <div className="flex gap-2">
            <input
              type="submit"
              value="Save"
              className="w-20 bg-lime-600 border-2 border-lime-600 hover:bg-white hover:text-lime-600 py-2 rounded md:w-30 transition-all duration-300"
            />
            <button
              className={clsx(
